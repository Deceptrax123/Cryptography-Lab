...
def decrypt(Matrix, encList):
    plain = []
    for i in range(len(encList)):
        c1 = 0
        c2 = 0
        ele1_x, ele1_y = search(Matrix, encList[i][0])
        ele2_x, ele2_y = search(Matrix, encList[i][1])
...
plain_decrypted = decrypt(Matrix, CipherList)

plain_text = ""
for i in plain_decrypted:
    plain_text += i
